...
import HashTag from './../../components/Lists/HashTag/HashTag';
...
const Register = () => {
    ...
    //     swal({
    //         title: "Opss ,there is an Error !",
    //         text: "Your Email has been taken | Please try with another account",
    //         icon: "error",
    //         button: "Aww nooo!",
    //     });
    // }, [error === true])
    ...
    return (
        <div className="register">
            ...
            <div className="header">
                <h1>Sign Up to Hashtag social media</h1>
